    ...
    public class ProductsProvider : IProductsProvider
    {
        ...
        private void SeedData()
        {
            if (dbContext.Products.Any())
            {
                ...
                dbContext.Products.Add(new Db.Product() { Id = 1, Name = "Mouse", Price = 5, Inventory = 200 });
                dbContext.Products.Add(new Db.Product() { Id = 1, Name = "Monitor", Price = 150, Inventory = 100 });
                dbContext.Products.Add(new Db.Product() { Id = 1, Name = "CPU", Price = 200, Inventory = 200 });
